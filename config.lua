...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(461.36, -996.49, 30.30)
		},

		Armories = {
			vector3(479.15, -996.67, 30.69)
		},

		Vehicles = {
			{
				Spawner = vector3(458.49, -999.16, 25.7),
...
Config.AuthorizedVehicles = {
	car = {
		...
		officer = {
			{model = 'policet', price = 10},
			{model = 'policeb', price = 10},
			{model = 'police4', price = 10},
			{model = 'riot', price = 10},
			{model = 'unmarked4', price = 10},
			{model = 'fbi2', price = 10}
		},
